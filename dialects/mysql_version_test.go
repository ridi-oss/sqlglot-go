...
func TestMySQLVersionSettingErrors(t *testing.T) {
	tests := []struct {
		...
		{name: "unknown setting", dialect: "mysql, future_setting=1", wantError: `unsupported dialect setting "future_setting" (supported: normalization_strategy, mysql_version, mysql_ansi_quotes, opaque_functions)`},
	}
