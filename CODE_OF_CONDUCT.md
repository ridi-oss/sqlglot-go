...
leaders responsible for enforcement by contacting a maintainer listed in
[CODEOWNERS](./.github/CODEOWNERS), or privately via the repository's **Security → Report a
vulnerability** channel. All complaints will be reviewed and investigated promptly and fairly.
...
1. **Correction** — Community Impact: use of inappropriate language or other unprofessional behavior.
   Consequence: a private, written warning, with clarity around the nature of the violation and an
...
3. **Temporary Ban** — Community Impact: a serious violation of community standards. Consequence: a
   temporary ban from any sort of interaction or public communication with the community for a
   specified period.
